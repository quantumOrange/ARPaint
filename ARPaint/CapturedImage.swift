...
class CapturedImage:ARMetalDrawable {
    ...
    let orientaion:UIInterfaceOrientation
   ...
   // var capturedImagePipelineState: MTLRenderPipelineState!
    ...
    func updateImagePlane(frame: ARFrame) {
        ...
        let displayToCameraTransform = frame.displayTransform(for: orientaion, viewportSize: viewportSize).inverted()
    ...
    init( device:MTLDevice, destination:RenderDestinationProvider, orientaion:UIInterfaceOrientation) {
